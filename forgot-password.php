...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $stmt = $conn->prepare("SELECT id, name, remember_token FROM users WHERE email = ?");
    ...
    $stmt->close();
        ...
        try {
            ...
            <p style='font-family: Arial, sans-serif; font-size: 13px; color: #666666; text-align: center; margin-top: 25px;'>
                ...
                <a href='nama-aplikasi.com' style='color: #007BFF;'>            nama-aplikasi.com             </a>
            </p>
  ...
  $_SESSION['message'] = 'Email berisi instruksi lebih lanjut telah dikirim ke alamat email yang Anda berikan. Jika Anda tidak menerima pesan dalam 5 menit, periksa folder spam. Jika Anda masih mengalami masalah, hubungi dukungan di nomor 081220931777';
  header('Location: forgot-password');
  exit;
}
?>
