...
$query_status_karyawan = "
    ...
    FROM users
    WHERE id_company = ? 
    AND user_status IN ('Part-time', 'Magang', 'Training', 'Probation', 'Contract', 'Permanent', 'Lainnya')
    AND status = 'active' 
...
// Proses hasil query dan simpan ke dalam array
// Inisialisasi awal untuk mencegah kesalahan
$data_jk_karyawan = [
    'laki_laki' => 0,
    'perempuan' => 0,
    'lainnya' => 0
...
<head>
  ...
  <style>
      .table-scroll {
          max-height: 150px;       /* scroll atas–bawah */
          overflow-y: auto;
  ...
  <div id="wrapper">
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <p>Hari ini adalah: <?php echo $hari . ", " . $tanggal; ?></p>

        <?php if ($sesi_user['role'] !== 'staff'): ?>
        <div id="messages">
            <div class="alert alert-danger mt-3">
                <div class="text-center p-1">
                    <strong>Anda tidak berhak mengakses halaman ini...!</strong>
                </div>
            </div>
        </div>
        <?php else: ?>
            ...
            <div class="card">
              ...
              <div class="table-responsive table-scroll">
                <table class="table align-items-center">
                    <thead>
                        <tr>
                              <th class="mb-0"><h6>Total</h6></th>
                              <th> </th>
                              <th class="mb-0"><h6><?= $total_karyawan_hingga_bulan_ini ?></h6></th>
                        </tr>
                    </thead>
                  <tbody>
                    <tr>
                      <td class="small-font"><i class="fa fa-circle" style="color: rgba(255, 99, 132, 1);"></i> Part Time</td>
                    ...
                    <tr>
                      <td class="small-font"><i class="fa fa-circle" style="color: rgba(153, 102, 255, 1);"></i> Contract</td>
                    ...
                    <tr>
                      <td class="small-font"><i class="fa fa-circle" style="color: rgba(255, 159, 64, 1);"></i> Permanent</td>
