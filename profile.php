...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <p class="h5"><?= $_SESSION["user"]["company_name"] ?></p>
        ...
        <?php endif; ?>
    <div class="row mt-3">
        <form action="profile-update" method="POST" class="w-100" enctype="multipart/form-data"> <!-- form pembungkus -->
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nip" name="nip" placeholder="Nomor ID Karyawan"
                                value="<?= $row_karyawan['nip'] ?>" readonly>
                        </div>
                        
                        <input type ="hidden" class="form-control" id="role" name="role" value ="<?= $row_karyawan['role'] ?>">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="hidden" id="status" name="status" value="<?= $row_karyawan['status'] ?>">
                        <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="gaji_pokok" name="gaji_pokok" placeholder="Gaji Pokok"
                                value="<?= $row_karyawan['gaji_pokok'] ?>" readonly>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tunjangan_transport" name="tunjangan_transport" placeholder="Tunjangan Transport"
                                value="<?= $row_karyawan['tunjangan_transport'] ?>" readonly>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tunjangan_makan" name="tunjangan_makan"
                                ...
                                value="<?= $row_karyawan['tunjangan_makan'] ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tunjangan_jabatan" name="tunjangan_jabatan"
                                ...
                                value="<?= $row_karyawan['tunjangan_jabatan'] ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tunjangan_lainnya" name="tunjangan_lainnya"
                                ...
                                value="<?= $row_karyawan['tunjangan_lainnya'] ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="ket_tunjangan_lainnya" name="ket_tunjangan_lainnya" rows="2"
                                placeholder="Keterangan tambahan tunjangan lainnya" readonly><?= $row_karyawan['ket_tunjangan_lainnya'] ?></textarea>
                        </div>
                        <div class="form-group">
    ...
    <div class="form-group text-center">
      ...
      <a href="index" class="btn btn-light px-5">
